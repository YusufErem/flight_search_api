from flight_info.serializer import HavaalanlariSerializer, UcuslarSerializer, UserSerializer
from flight_info.models import Havaalanlari, Ucuslar, Customer
